...
\hypersetup{pdfstartview=FitH,  linkcolor=blue, %
...
\begin {document}
    ...
    \begin{frame}[containsverbatim]{Пример}
...
instance Applicative MyData
        ...
        \end{examplefirst}
    \end{columns}
\begin{examplefirst}{Ошибка:}
\small{
\texttt{One.hs:7:10:}\\
~~~~\texttt{\small{No instance for (Applicative MyData)}} \\
<\ldots>}
\end{examplefirst} 
    \end {frame}
  ...
  \node {ClsInstDecl}
    ...
    child { node {$\ldots$}};
      \end{tikzpicture}
      \begin{examplefirst}{\small{\textit{Более подробно:}}}
            \scriptsize \url{https://ghc.haskell.org/trac/ghc/wiki/Migration/7.10}        \end{examplefirst}
    \end {frame}
...
f mp = case mp of {
    ...
    \begin{frame}{Результаты работы}
        ...
        \begin{examplefirst}{Репозиторий с исходными кодами:}
            \begin{itemize}
            \item \scriptsize{\url{https://github.com/Valoisa/Generate-ancestor-instances}}
            \end{itemize}
        \end{examplefirst}
    \end{frame}
